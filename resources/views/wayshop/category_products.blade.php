                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                ...
                                <div class="list-group-collapse sub-men">
                                    ...
                                    <div class="collapse " id="{{ $cat->id }}" data-parent="#list-group-men"> 
                                        {{-- class= collapse show will show the submenu without click on menu --}}
                                        <div class="list-group">
                                            @foreach($cat->categories as $key => $subcat)
                                            <a href="{{route('categories.product',$subcat->id)}}" class="list-group-item list-group-item-action">{{$subcat->name}}</a>
                                            @endforeach
                        ...
                        <div class="row product-categorie-box">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                    ...
                                    <h1 align="center"><strong>Category: </strong>{{$category_name->name}}</h1><br>
                                            ...
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        ...
                                                        <a class="cart" href="{{ route('productdetails',$pro->id) }}">Detail Page</a>
                                                    </div>
                                                </div>
                                                <div class="why-text">
